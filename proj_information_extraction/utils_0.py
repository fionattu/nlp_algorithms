...
#         # todo: data processing unit: generate train/valid files
#         sentences, tags = [], []
#         with open(self.config.train_path, 'r') as data:
#             for line in data:
...
#         # todo: dataset: https://github.com/codertimo/BERT-pytorch/blob/master/bert_pytorch/dataset/dataset.py
#         # use dataloader
