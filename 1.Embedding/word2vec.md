...
目标函数(objective function)和梯度下降的公式推导见<a href="https://github.com/fionattu/nlp_algorithms/blob/master/pics/w2v_derivation.pdf" target="_blank" rel="noopener">w2v公式推导</a>。
